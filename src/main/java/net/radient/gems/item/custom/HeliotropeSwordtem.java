...
public class HeliotropeSwordtem extends SwordItem {

    public HeliotropeSwordtem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
